...
/// <summary>
/// Contains test code for building test boards
/// </summary>
public class TestBoardBuilder : BoardBuilder
{
    /// <summary>Creates a new instance of a TestBoardBuilder</summary>
    /// <param name="game">The game to build a board in</param>
    public TestBoardBuilder(Game game) => Game = game;
