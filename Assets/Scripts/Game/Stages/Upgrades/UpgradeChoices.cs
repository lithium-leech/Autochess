...
public abstract class UpgradeChoices
{
    ...
    /// <summary>Instantiated sprites shown in the upgrade menu</summary>
    protected IList<GameObject> Sprites { get; set; } = new List<GameObject>();

    /// <summary>Instantiated sprites shown in the info section</summary>
    protected IList<GameObject> InfoSprites { get; set; } = new List<GameObject>();
    ...
    {
        foreach (GameObject sprite in Sprites) GameObject.Destroy(sprite);
        Sprites.Clear();
    }
    ...
    {
        // Remove sprites
        foreach (GameObject sprite in InfoSprites) GameObject.Destroy(sprite);
        InfoSprites.Clear();
