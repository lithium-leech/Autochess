...
/// </summary>
public class Taliah : Piece
{
    public override AssetGroup.Piece Kind => AssetGroup.Piece.Taliah;
    ...
    public override void TakeTurn()
    {
        ...
        if (IsValidPath(ur, false)) AddLinearPaths(ur, 1, 1, 100, false, moves, captures);
        if (IsValidPath(dr, false)) AddLinearPaths(dr, 1, -1, 100, false, moves, captures);
        if (IsValidPath(dl, false)) AddLinearPaths(dl, -1, -1, 100, false, moves, captures);
        if (IsValidPath(ul, false)) AddLinearPaths(ul, -1, 1, 100, false, moves, captures);
