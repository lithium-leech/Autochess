...
func load_display():
	...
	game_window.position.x = (-496 * game_min_scale) + (screen_size.x - display_size.x) / 2
	game_window.position.y = (-352 * game_min_scale) + (screen_size.y - display_size.y) / 2
